class Huesped < ActiveRecord::Base
  ...
  attr_accessible :direccion, :documento, :email, :fecha_nacimiento, :primer_apellido, :primer_nombre, :segundo_apellido, :segundo_nombre, :tiposdeidentificacion_id, :avatar
