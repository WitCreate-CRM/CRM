...
empleados = Empleado.create([{:avatar => File.open(File.join(Rails.root, "/public/system/avatares/1/thumb/norly.png")),codigo: '01', cargo_id:'1', primer_nombre:'Norley', segundo_nombre:'', apellido:'Arenas', tiposdeidentificacion_id:'1', documento:'3203409423', departamento_id:'1'},
	...
	{:avatar => File.open(File.join(Rails.root, "/public/system/avatares/1/thumb/daniel.png")),codigo: '01', cargo_id:'2', primer_nombre:'Daniel', segundo_nombre:'', apellido:'Marin', tiposdeidentificacion_id:'1', documento:'3203409423', departamento_id:'3'}, 
