...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { celular: @contacto.celular, email: @contacto.email, fecha_nacimiento: @contacto.fecha_nacimiento, nombre: @contacto.nombre }
    end
  ...
  test "should update contacto" do
    put :update, id: @contacto, contacto: { celular: @contacto.celular, email: @contacto.email, fecha_nacimiento: @contacto.fecha_nacimiento, nombre: @contacto.nombre }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
