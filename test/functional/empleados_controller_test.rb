...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { documento: @empleado.documento, primer_apellido: @empleado.primer_apellido, primer_nombre: @empleado.primer_nombre, segundo_apellido: @empleado.segundo_apellido, segundo_nombre: @empleado.segundo_nombre }
    end
  ...
  test "should update empleado" do
    put :update, id: @empleado, empleado: { documento: @empleado.documento, primer_apellido: @empleado.primer_apellido, primer_nombre: @empleado.primer_nombre, segundo_apellido: @empleado.segundo_apellido, segundo_nombre: @empleado.segundo_nombre }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
